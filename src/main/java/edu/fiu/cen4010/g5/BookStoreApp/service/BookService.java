...
public class BookService {
    ...
    public List<Book> getBookByBOOKPUBLISHER(String publisher) {
        return bookRepository.findByBOOKPUBLISHER(publisher);
    }
    public List<Book> getBookByPUBLISHEDYEAR(String publishedYear) {
        return bookRepository.findByPUBLISHEDYEAR(publishedYear);
    }
    public List<Book> getBookByCOPIESSOLD(String copiesSold) {
